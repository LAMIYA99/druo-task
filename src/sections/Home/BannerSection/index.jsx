  ...
  return (
    <div className="container mx-auto  ">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-5">
        ...
        <div className="grid grid-rows-2 gap-4 font-primary relative md:h-full">
          <img
            src="https://drou-electronics-store.myshopify.com/cdn/shop/files/bnr1_grande.jpg?v=1674276675"
            alt="Small 1"
            className="w-full h-full object-cover "
          />
          <div className="absolute  top-[80px] left-[30px] flex items-start flex-col">
          ...
          <img
            ...
            className="w-full h-full object-cover "
          />
          <div className="absolute bottom-[110px] left-[30px] flex items-start flex-col">
            <ul className="text-[#fff] flex items-center gap-2 mb-[5px]">
              <li className="text-[15px] font-normal leading-[1.74] ">
              SMART WATCH
              </li>
            ...
            <h3 className="text-[#e4573d] text-[24px] font-bold">$15.00</h3>
          </div>
        </div>
      </div>
    </div>
